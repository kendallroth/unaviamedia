...
function createMessageTimer(messageId, timeout, svg_size) {
	...
	var messageHTML = String.format(
		"	<svg class='message__timer close' data-close width='{0}' height='{0}' css='display: none;'><g>" +
 ...
 * @param	timeout			Length of the message timeout
 * @param	circumfrence	Circumference of circle (necessary for animation)
 */
