...
<section id="about-wrapper">
	...
	<div class="row about-introduction">
		<div class="column">
			<h2>Introduction</h2>
	...
	<div class="row about-education">
		<div class="column">
			<h2>Education</h2>
			<h3>Computer Programmer/Analyst<span class="date-right">2014&mdash;present</span></h3>
	...
	<div class="row about-employment">
		<div class="column">
			<h2>Employment</h2>

			<h3>Web Developer <span class="employment-type">(Coop)</span></h3>
			...
			<h3>Web Developer <span class="employment-type">(Work Study)</span></h3>
